...
############################################################################################################################################################################################
$PIN = Get-GoogleAuthenticatorPin -Secret ХЕШКЛЮЧ
$PIN | Get-Member
$PIN.'PIN Code'
############################################################################################################################################################################################
############################################################################################################################################################################################
$Login = "Сюда вписать свой логин"
$Passw = "Сюда вписать свой пароль"
$result = $Login, $passw, $PIN.'PIN Code'
$result | out-file ".\VPNData.txt" -Encoding Ascii
############################################################################################################################################################################################
